...
export default async function DashboardDadosPage() {
  const [anual, segmentos, indicadores, projecoes, ranking, selic, ipca, dolar, desemprego, pibTrimestral, pibEstado, pmcData, cagedComercio, cagedServicos, cagedAlojamento, cagedTotal, consumidorPainel] = await Promise.all([
    getFaturamentoAnual(),
    getSegmentos("anual"),
    getIndicadores(),
    getProjecoes(),
    ...
    getEmpregoCaged("alojamento", 36),
    getEmpregoCaged("total", 36),
